...
{{< figure src="/img/final/f1.png" alt="Landing page of The Userscript Tour" position="center" style="width: 550px; border-radius: 4px;">}}
...
{{< figure src="/img/final/f2.png" alt="Mission 1 starts" position="center" style="width: 550px; border-radius: 4px;">}}
...
{{< figure src="/img/final/f3.png" alt="Mission 2 starts" position="center" style="width: 550px; border-radius: 4px;">}}
...
{{< figure src="/img/final/f4.png" alt="Mission 3 starts" position="center" style="width: 550px; border-radius: 4px;">}}
...
{{< figure src="/img/final/f5.png" alt="Mission 4 starts" position="center" style="width: 550px; border-radius: 4px;">}}

{{< figure src="/img/final/f6.png" alt="Mission 4 ends" position="center" style="width: 550px; border-radius: 4px;">}}

## ✨ Other hightlights

- A welcome message is sent to the Talk page when the user initiates The Userscript Tour (Mission 1).

{{< figure src="/img/final/f7.png" alt="Welcome message on Talk page" position="center" style="width: 550px; border-radius: 4px;">}}
...
{{< figure src="/img/final/f8.png" alt="A badge awarded in Mission 1" position="center" style="width: 550px; border-radius: 4px;">}}
...
{{< figure src="/img/final/f9.png" alt="All badges awarded in The Userscript Tour" position="center" style="width: 550px; border-radius: 4px;">}}
